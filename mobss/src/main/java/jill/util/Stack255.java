...
public class Stack255{
	...
	/** 
	 * Specifies the increment by which the capacity should be extended,
	 * once the stack reaches full capacity
	 */
	...
	/**
	 * Creates a stack with the given initial capacity, to be extended
	 * by the given incrementSize as needed upon reaching full capacity.
	 * Typically it should suffice to initialise the stack with the
	 * full capacity, if it is known upfront, since increasing capacity
	...
	/**
	 * Grows the stack capacity by {@link #increment} up to the maximum
	 * capacity of 255 (byte size).
